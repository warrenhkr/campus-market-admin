-- ================================================================
-- CAMPUS MARKET - SCHÉMA COMPLET SUPABASE (VERSION COMPATIBLE)
-- ================================================================

-- ================================================================
-- PART 1: ENUMS (Types personnalisés)
-- ================================================================
...
DO $$ BEGIN
    CREATE TYPE public.order_status AS ENUM ('PENDING', 'COMPLETED', 'CANCELLED', 'SHIPPED', 'DELIVERED');
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
...
DO $$ BEGIN
    CREATE TYPE public.product_status AS ENUM ('PENDING_REVIEW', 'APPROVED', 'REJECTED', 'HIDDEN');
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
...
DO $$ BEGIN
    CREATE TYPE public.support_ticket_category AS ENUM ('TECHNICAL', 'BILLING', 'ACCOUNT', 'DISPUTE', 'OTHER');
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
...
DO $$ BEGIN
    CREATE TYPE public.system_alert_severity AS ENUM ('INFO', 'WARNING', 'ERROR', 'CRITICAL');
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
